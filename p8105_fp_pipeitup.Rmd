...
author: "Yingxi Ji, Yeqing Ji, Wurongyan Zhang, Yiling Yang, Yanni Wang"
date: "11/6/2019"
...
The anticipated dataset is OSMI Mental Health Survey in Tech Survey, which can be found at https://osmihelp.org/research. This survey is an annual survey regarding mental health of people in tech companies conducted by Open Source Mental Illness (OSMI),  a non-profit organization. We will employ the most recent 3 years’ data (i.e. 2016-2018).
...
##### Visualizations:
Using plot.ly to draw Bar graph, heat map, correlation matrix, region map, classification tree
