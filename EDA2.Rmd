...
```{r}
model1=lm((log(suicides_100k_pop+1))~log(gdp_for_year)+year+sex+age_group+gdp_for_year+gdp_per_capita, data = maindata)
...
modelus=lm(poly(suicides_100k_pop,2)~log(gdp_for_year)+sex+age_group+gdp_per_capita, data = us)
